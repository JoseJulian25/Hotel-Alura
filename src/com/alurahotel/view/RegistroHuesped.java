...
public class RegistroHuesped extends JFrame {
	...
	public void GuardarHuesped() {
		try {
			...
			controllerHuesped.guardar(huesped, idReserva);
	...
	public void NumeroDeReserva(JTextField numero, Reserva reserva) {
		String numeroDeReserva = (String) reserva.getId().toString();
		numero.setText(numeroDeReserva);
	}
