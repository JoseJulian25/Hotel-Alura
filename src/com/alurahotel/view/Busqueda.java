...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		lblNewLabel_4.setBounds(331, 62, 325, 42);
	...
	public void cargarBusqueda() {
		List<Huesped> huespedes = this.huespedController.listar(txtBuscar.getText());
		List<Reserva> reservas = this.reservaController.listar(txtBuscar.getText());
	...
	public void eliminar() {
		if(!tieneFilaElegidaReservas() && !tieneFilaElegidaHuesped()) {
